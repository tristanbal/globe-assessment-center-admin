...
<script type="text/javascript">
    $(document).ready(function() {
         $('#basic-datatables').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{route('divisions.ajaxdata')}}",
            "columns":[
                { data: "divisionName",name: "divisions.name" },
                { data: "groupName",name: "groups.name" },
                { data: "created_at",name: "divisions.created_at"},
                { data: "updated_at",name: "divisions.updated_at"},
                { 
                    data: "id",                   
                    "render": function ( data, type, row ) {
                        var view  = '<div style = "display: flex;"> <a style = "float: left;" href = "division/view/'+ row.id +'"><div class = "btn-info btn">VIEW</div></a>';
                        var edit =  '<a style = "float: right;" href = "division/edit/'+ row.id +'"><div class = "btn-success btn">EDIT</div></a>';  
                        var del =  '<a style = "float: right;" href = "division/delete/'+ row.id +'"><div class = "btn-danger btn">DELETE</div></a></div>';   
