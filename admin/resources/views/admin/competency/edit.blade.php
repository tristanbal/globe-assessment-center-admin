...
<div class="container">
    ...
    {{  Form::open(array('action' =>[ 'CompetencyController@update',$competency->id]))}}
        <div class="row">
            <div class="col-md-12">
                <div class="form-group form-floating-label">
                    <input id="inputFloatingLabel" name="name" type="text" value="{{$competency->name}}" class="form-control input-border-bottom" required>
                    <label for="inputFloatingLabel" class="placeholder">Competency Name</label>
                        ...
                        <div class="form-group ">
                            ...
                            <select id="test1" class="form-control dropdown-subcluster" name="subclusterID" style="width:100%;" required>
                                @if(count($subcluster) > 0)
                                    ...
                                    @if ($row->id == $competency->subclusterID)
                                        selected
                        ...
                        <div class="form-group ">
                            ...
                            <select id="test4" class="form-control dropdown-talent" name="talentSegmentID" style="width:100%;" required>
                                @if(count($talentSegment) > 0)
                                    ...
                                    @if ($row->id == $competency->talentSegmentID)
                                        selected
                        ...
                        <div class="form-group ">
                            ...
                            <select id="test2" class="form-control dropdown-minimum" name="minimumLevelID" style="width:100%;" required>
                                @if(count($level) > 0)
                                    ...
                                    @if ($row->id == $competency->minimumLevelID)
                                        selected
                        ...
                        <div class="form-group ">
                            ...
                            <select id="test3" class="form-control dropdown-maximum" name="maximumLevelID" style="width:100%;" required>
                                @if(count($level) > 0)
                                    ...
                                    @if ($row->id == $competency->maximumLevelID)
                                        selected
                ...
                <div class="form-group input-group"><br>
                    ...
                    <textarea class="form-control" aria-label="With textarea" name="definition">{{$competency->definition}}</textarea>
                </div>
                <div class="form-group form-floating-label">
